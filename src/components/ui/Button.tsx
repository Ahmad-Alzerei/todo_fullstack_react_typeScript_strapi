...
const buttonVariants = cva(
  "rounded-md font-medium text-white duration-300 dark:text-black flex items-center justify-center disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        // ** FILLED
        ...
        danger:
          "bg-red-700 dark:bg-red-600 dark:text-white dark:hover:bg-red-700",
        cancel:
